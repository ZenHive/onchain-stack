defmodule Cartouche.Trace do
  ...
  def deserialize(%{"subtraces" => subtraces, "type" => type} = params) when is_integer(subtraces) and is_binary(type) do
    %__MODULE__{
      ...
      subtraces: subtraces,
      trace_address: decode_trace_address(params["traceAddress"]),
  ...
  ## Examples
      ...
      ...>   "type" => "call"
      ...> }]
      ...> |> Cartouche.Trace.deserialize_many()
      [
        %Cartouche.Trace{
          action: %Cartouche.Trace.Action{
            call_type: "call",
