...
**Modules:** `Cartouche.Solana.Transaction`, `Cartouche.Solana.SystemProgram`
**Dependencies:** `Cartouche.Base58` (Phase 0), `Cartouche.Solana.Keys` / `Cartouche.Solana.Signer` (Phase 1)
...
```
lib/cartouche/solana/transaction.ex      # Transaction, Message, Instruction, etc.
lib/cartouche/solana/system_program.ex   # SystemProgram
