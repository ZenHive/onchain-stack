...
defmodule Onchain.MixProject do
  ...
  defp package do
    [
      licenses: ["MIT"],
      links: %{
        "GitHub" => "https://github.com/ZenHive/onchain-stack/tree/main/packages/onchain",
        "Changelog" => "https://github.com/ZenHive/onchain-stack/blob/main/packages/onchain/CHANGELOG.md"
      },
  ...
  defp docs do
    [
      ...
      # this pattern every generated doc link 404s against packages/onchain/lib/…
      # instead of the repo-root-relative path GitHub actually serves.
      source_url_pattern:
        "https://github.com/ZenHive/onchain-stack/blob/onchain-v#{@version}/packages/onchain/%{path}#L%{line}"
    ]
  end
